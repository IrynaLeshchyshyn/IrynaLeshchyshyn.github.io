...
/*
  ...
  $(document).on('scroll', function () {
        var position = $body.scrollTop(),
            block_position = $('#servise-bkg').offset().top;
...
/*
    ...
    var box1 = $('#servise-bkg').offset().top;
        Если сделали скролл на 100px задаём новый класс для header
    if(box1 > 300){
    $('.navigation ul').addClass('header-fixed');
    } else{
      Если меньше 100px удаляем класс для header*
    $('.navigation ul').removeClass('header-fixed');
    }
